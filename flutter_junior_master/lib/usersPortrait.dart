...
class _UsersPortraitState extends State<UsersPortrait> {
  ...
  createAlertDialog(BuildContext context) {
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title:
                Text(S.current.titlePopUpCreate, textAlign: TextAlign.center),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                TextField(
                  decoration: InputDecoration(hintText: 'Hermion'),
  ...
  Widget _customListViewBuilder(
      String title, String birthdate, int index, User user) {
    return Slidable(
      child: Container(
        height: 150,
